...
namespace HotelierProject.WebApi.Controllers
{
    ...
    public class DashbordWidgetController : ControllerBase
    {
        ...
        public DashbordWidgetController(IStaffsService staffsService, IBookingService bookingService, IAppUserService appUserService, IRoomService roomService)
        {
        ...
        {
            var value = _staffsService.TGetStaffCount();
            return Ok(value);
        }
